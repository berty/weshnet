...
replace (
	berty.tech/go-ipfs-log => github.com/TERITORI/go-ipfs-log v0.0.0-20231118193734-c1def2afaa6b
	berty.tech/go-ipfs-repo-encrypted => github.com/berty/go-ipfs-repo-encrypted v1.3.1-0.20231118185348-f06ac2908fbf
	berty.tech/go-orbit-db => github.com/TERITORI/go-orbit-db v0.0.0-20231118194538-602509d6d533
	github.com/berty/go-libp2p-pubsub => github.com/TERITORI/go-libp2p-pubsub v0.0.0-20231118190217-538eb681b2af
	github.com/berty/go-libp2p-rendezvous => github.com/n0izn0iz/go-libp2p-rendezvous v0.0.0-20231118181017-b03accac730d
)
