...
func file_protocoltypes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protocoltypes_proto_msgTypes[95].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protocoltypes_proto_msgTypes[155].Exporter = func(v interface{}, i int) interface{} {
